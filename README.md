...
to indicate rows, columns, and pieces, and these option/value pairs can be provided in any order. You need
to make sure you handle inappropriate data, i.e.
non-positive integers, and ask the user again for the correct input. You do not have to recoverfrom bad
options. You must continue to play the game, until the user no longer wants to play, without creating a
memory leak!
